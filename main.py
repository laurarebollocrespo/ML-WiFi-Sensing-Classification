...
def build_stacking():
    ...
    return StackingClassifier(
        estimators=[
            ...
            ('svm', SVC(class_weight='balanced', probability=True, random_state=42)), # Must keep probability=True to allow stacking!
...
MODEL_REGISTRY = {
    ...
    "logistic": lambda: LogisticRegression(class_weight='balanced', random_state=42),
    "svm": lambda: SVC(class_weight='balanced', probability=True, random_state=42),

    # Trees & Ensembles
    "random_forest": lambda: RandomForestClassifier(class_weight='balanced', random_state=42, n_jobs=-1),
    "extra_trees": lambda: ExtraTreesClassifier(class_weight='balanced', random_state=42, n_jobs=-1),
    "gradient_boosting": GradientBoostingClassifier,
    "hist_gradient_boosting": lambda: HistGradientBoostingClassifier(class_weight='balanced', random_state=42),
