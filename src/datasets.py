...
def process_datasets():
    ...
    # 1. Original dataset
    train.to_csv(
        os.path.join(processed_dir, "train_original.csv"), sep=";", index=False
    )
    ...
    test_feat.to_csv(
        os.path.join(processed_dir, "test_features.csv"), sep=";", index=False
    )
    ...
    train_boxcox.to_csv(
        os.path.join(processed_dir, "train_boxcox.csv"), sep=";", index=False
    )
    test_boxcox.to_csv(
        os.path.join(processed_dir, "test_boxcox.csv"), sep=";", index=False
    )
    ...
    test_iqr_boxcox.to_csv(
        os.path.join(processed_dir, "test_iqr_boxcox.csv"), sep=";", index=False
    )
    ...
    test_lof_boxcox.to_csv(
        os.path.join(processed_dir, "test_lof_boxcox.csv"), sep=";", index=False
    )
    ...
    test_feat_boxcox.to_csv(
        os.path.join(processed_dir, "test_features_boxcox.csv"), sep=";", index=False
    )
    ...
    test_feat_iqr_boxcox.to_csv(
        os.path.join(processed_dir, "test_features_iqr_boxcox.csv"),
        sep=";",
        index=False,
    )
    ...
    test_feat_lof_boxcox.to_csv(
        os.path.join(processed_dir, "test_features_lof_boxcox.csv"),
        sep=";",
        index=False,
    )
    ...
    train_feat_lof.to_csv(
        os.path.join(processed_dir, "train_features_lof.csv"),
        sep=";",
        index=False,
    )
    test_feat_lof.to_csv(
        os.path.join(processed_dir, "test_features_lof.csv"),
        sep=";",
        index=False,
    )
